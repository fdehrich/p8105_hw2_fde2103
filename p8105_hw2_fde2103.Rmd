...
Here, using the strategy Jeff presented during the live session, I am  replace month number with month name. I am also creating a `president` variable taking values `gop` and `rep`, removing `prez_dem` and `prez_gop`, and removing the `day` variable.
